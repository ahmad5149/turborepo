...
export function offsiteFindYourRidePageContent() {
    return useSanity(groq`${queries.offsiteFindYourRideQuery}`);
}
export function inventoryPageContent() {
    return useSanity(groq`${queries.inventoryQuery}`);
}
export function useOffsiteContent() {
    return useSanity(groq`${queries.offsiteInvQuery}`);
}
export function useOffsiteCarDetailsContent() {
    return useSanity(groq`${queries.offsiteCarDetailsQuery}`);
}
export function usePartnerSalesCarDetailsContent() {
    return useSanity(groq`${queries.partnerSalesCarDetailsQuery}`);
}
