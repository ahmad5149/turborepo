    ...
    const renderThumbs = (children) => {
        return children.map((item, index) => (
            <div
                ...
                {/* {(status == "pending" || status == "cancelled" || item.status == "deposit") && (
                    <Image
                ...
                <section>
                    <div className="px-0 row white-bg">
                        <div className="d-flex flex-column align-items-start mt-5 heading-div col-xl-8 col-lg-8 col-md-6 col-sm-6 ">
                            ...
                            {carData && carData.dealerStockId != null && carData.dealerStockId != "" && (
                                <h4 className="d-flex align-items-center">
                                    Stock: {carData.dealerStockId}
                                    <CarInformationModalSVG />
                                    <div
                                        className=""
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6  row price-desktop-div">
                            <div className="d-flex flex-column  mb-2 price-div col-xl-12 col-lg-12 ">
                                <h2>{price && !searchParams.get("share") ? `$${price.toLocaleString()}` : null}</h2>
                        ...
                        <div className="col-xl-3 col-lg-12 right-side-content me-0">
                            <div className="card py-3 px-4">
                                    ...
                                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-12 d-flex align-items-center mb-xl-3">
                                        <div className="d-flex flex-column border-radius-25 mobile-dir-list">
                                            <div
                                                ...
                                                <ConfirmAvailabiltySVG />
                                                <p className="text-white mt-2">Confirm Availability</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div className="d-flex  border-radius-25 mobile-dir-list">
                                            <a
                                                ...
                                                <CarDetailsCallSVG />
                                                <p className="text-white mt-2">Click to Call</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-12 items-row mt-1">
                                    ...
                                    <div className="col-sm-6 col-md-6 col-lg-6 mt-1 col-xl-12 d-flex align-items-center  mb-xl-2">
                                        <div
                                            className="d-flex border-radius-25 mobile-dir-list"
                                            onClick={calculatePaymentAction}>
                                            <div className="tab-deatil">
                                                <CalculatePaymentSVG />
                                                <p className="text-white mt-2">Calculate Payment</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-12 d-flex align-items-center mt-2 mb-xl-2">
                                        <div
                                            className="d-flex border-radius-25 mobile-dir-list"
                                            onClick={calculatePaymentAction}>
                                            <div
                                                ...
                                                <OrigWindowSVG />
                                                <p className="text-white mt-2">Orig Window Sticker</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-12 items-row mt-2">
                                    <div
                                        className="col-sm-6 col-md-6 col-lg-6 col-xl-12 d-flex align-items-center mb-xl-3"
                                        onClick={() =>
                                            openNotifyDealerModal(
                                                carData.vin,
                                                carData.dealerStockId,
                                                carData.year,
                                                carData.make,
                                                carData.model
                                            )
                                        ...
                                        <div className="d-flex flex-column border-radius-25 mobile-dir-list">
                                            <div className="tab-deatil">
                                                <OrigWindowSVG />
                                                <p className="text-white mt-2">Buy Now</p>
                                            </div>
                                        </div>
                                    </div>
                                </div> */}
                                ...
                                <div className="row">
                                    {phoneNumber && (
                                        <div
                                            className="col-lg-12 col-xl-12 col-md-6 col-sm-12 mb-2 d-flex align-items-center mb-xl-2"
                                            ref={btnRef}>
                                            <div className="d-flex  border-radius-25 mobile-dir-list">
                                    ...
                                    {dealerData && dealerData.crmEmail && dealerData.crmEmail != "" && (
                                            ...
                                            <div className="d-flex  border-radius-25 mobile-dir-list">
                                                <div className="bg-tab-detail">
                                                    <div
                                                        className="tab-deatil"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#tradeToolModal">
                                                        {/* <CarDetailsCallSVG /> */}
                                                        <ValueMyTradeSVG />
                                                        <p className="text-white mt-2">
                                                            {offsitePageData?.configurableButtons?.sellCar}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    {dealerData && dealerData.prequelURL && dealerData.prequelURL != "" && (
                                        <div className="col-lg-12 col-xl-12 col-md-6 col-sm-12 mb-2 d-flex align-items-center mb-xl-2">
                                            <div
                                                className="d-flex border-radius-25 mobile-dir-list"
                                                // onClick={calculatePaymentAction}
                                            >
                                                <div className="bg-tab-detail">
                                                    <a
                                                        ...
                                                        <CalculatePaymentSVG />
                                                        <p className="text-white mt-2">
                                                            {offsitePageData?.configurableButtons?.getFinance}
                                                        </p>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    {user && userValidDealership && (
                                        <div className="col-lg-12 col-xl-12 col-md-6 col-sm-12 mb-2 d-flex align-items-center mb-xl-3">
                                            <div
                                                className="d-flex flex-column border-radius-25 mobile-dir-list"
                                                onClick={() =>
                                                    openNotifyDealerModal(
                                                        carData.vin,
                                                        carData.dealerStockId,
                                                ...
                                                <div className="bg-tab-detail">
                                                    <div className="tab-deatil">
                                                        <OrigWindowSVG />
                                                        <p className="text-white mt-2">
                                                            {offsitePageData?.configurableButtons?.buyNow}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
