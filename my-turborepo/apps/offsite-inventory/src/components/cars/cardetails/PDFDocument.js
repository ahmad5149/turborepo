            ...
            <View style={styles.section}>
                ...
                <View style={[styles.vehicleDescription]}>
                    <Text style={[styles.colText, styles.text10]}>
                        SELLER: {purchaseAgreement?.sellerData?.name} /{" "}
                        {purchaseAgreement?.sellerData?.managerFirstName}{" "}
                        {purchaseAgreement?.sellerData?.managerLastName}
                    </Text>
                    <Text style={[styles.colText, styles.text10]}>DATE: {purchaseAgreement?.currentDate}</Text>
                </View>
                <View style={[styles.vehicleDescription]}>
                    <Text style={[styles.colText, styles.text10]}>
                ...
                <View style={[styles.vehicleDescription]}>
                    ...
                    <Text style={[styles.colText, styles.text10]}>
                        EMAIL: {purchaseAgreement?.sellerData?.managerEmail}
                    </Text>
                </View>
                ...
                <View style={[styles.purchaseSection]}>
                    ...
                    <Text style={styles.addressText}>
                        {purchaseAgreement?.dealerData?.name} / {purchaseAgreement?.userName}{" "}
                        {purchaseAgreement?.dealerData?.address} {purchaseAgreement?.dealerData?.city},{" "}
                        {purchaseAgreement?.dealerData?.state} {purchaseAgreement?.dealerData?.dealerZipCode}{" "}
                        {purchaseAgreement?.dealerData?.phone}
                    </Text>
                </View>
                ...
                <View style={[styles.vehicleDescription]}>
                    ...
                    {/* <Text style={[styles.colText, styles.text10]}>IN EXCESS:</Text>
                    <Text style={[styles.colText, styles.text10]}>UNK:</Text> */}
                </View>

                <View style={[styles.purchaseSection]}>
                    <Text style={styles.text10}>CASH PURCHASE PRICE: $</Text>
                    <Text style={[styles.text10, styles.underline]}>
                        {/* {purchaseAgreement?.carData?.price?.toLocaleString()} */}
                        {(Number(purchaseAgreement?.carData?.dealerPrice) - 475).toLocaleString()}
                    </Text>
                </View>
                <View>
                ...
                <View style={[styles.vehicleDescription]}>
                    <Text style={[styles.colText, styles.text10]}>
                        BUYER NAME: {purchaseAgreement?.dealerData?.name} / {purchaseAgreement?.userName}
                    </Text>
                ...
                <View style={[styles.vehicleDescription]}>
                    <Text style={[styles.colText, styles.text10]}>
                        BUYER'S NAME: {purchaseAgreement?.dealerData?.name} / {purchaseAgreement?.userName}
                    </Text>
                </View>
                <View style={[styles.vehicleDescription]}>
                    <Text style={[styles.colText, styles.text10]}>
