...
function SecondaryDealership({ selectedMultiDealers, setSelectedMultiDealers, dealerOptions }) {
    ...
    return (
        <div className="s-dealership-desktop">
            <div className="row align-items-center">
                <div className="col-md-3 fv-row fv-plugins-icon-container">
                    <h4 className="fs-4 text-start">Secondary dealership</h4>
                </div>
                <div className="col-md-1 fv-row fv-plugins-icon-container text-start"></div>
                <div className="col-md-4">
                    <h4 className="ps-4  fs-4 text-start">Notification permissions</h4>{" "}
                </div>
                <div className="col-md-4">
                    <h4 className="ps-4  fs-4 text-start">Set rights</h4>
                </div>
            </div>
...
export default SecondaryDealership;
