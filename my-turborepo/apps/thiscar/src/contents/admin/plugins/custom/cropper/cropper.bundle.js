...
!(function (t, e) {
    ...
    function gt(t, e) {
        var i = t.style;
        lt(e, function (t, e) {
            ut.test(e) && et(t) && (t = "".concat(t, "px")), (i[e] = t);
        });
    }
    function ft(t, e) {
        if (e)
    ...
    function Lt(t) {
        var e = t.rotate,
            ...
            o = t.translateY,
            r = [];
        et(n) && 0 !== n && r.push("translateX(".concat(n, "px)")),
            et(o) && 0 !== o && r.push("translateY(".concat(o, "px)")),
            et(e) && 0 !== e && r.push("rotate(".concat(e, "deg)")),
            et(i) && 1 !== i && r.push("scaleX(".concat(i, ")")),
            et(a) && 1 !== a && r.push("scaleY(".concat(a, ")"));
    ...
    var At = {
            ...
            initContainer: function () {
                ...
                (this.containerData = r), gt(a, { width: r.width, height: r.height }), ft(t, k), vt(a, k);
            },
            initCanvas: function () {
            ...
            limitCanvas: function (t, e) {
                ...
                if (t) {
                    ...
                    var d = Yt({ aspectRatio: h, width: c, height: l });
                    (c = d.width),
                        (l = d.height),
                        (n.minWidth = c),
                        (n.minHeight = l),
            ...
            renderCanvas: function (t, e) {
                ...
                (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
                    ...
                    gt(
                        this.canvas,
                        dt({ width: i.width, height: i.height }, Lt({ translateX: i.left, translateY: i.top }))
                    ),
                    this.renderImage(t),
            ...
            renderImage: function (t) {
                ...
                dt(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
                    gt(
                        this.image,
                        dt({ width: i.width, height: i.height }, Lt(dt({ translateX: i.left, translateY: i.top }, i)))
                    ),
                    t && this.output();
            },
            ...
            renderCropBox: function () {
                ...
                (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
                    ...
                    t.movable &&
                        t.cropBoxMovable &&
                        Mt(this.face, H, i.width >= e.width && i.height >= e.height ? u : p),
                    gt(
                        this.cropBox,
                        dt({ width: i.width, height: i.height }, Lt({ translateX: i.left, translateY: i.top }))
                    ),
        ...
        jt = {
                ...
                if (
                    ...
                    "string" == typeof i ? (r = t.ownerDocument.querySelectorAll(i)) : i.querySelector && (r = [i]),
                        ...
                        lt(r, function (t) {
                            ...
                            Mt(t, N, { width: t.offsetWidth, height: t.offsetHeight, html: t.innerHTML }),
                                e && (i.crossOrigin = e),
                                (i.src = a),
                                (i.alt = n),
                                (i.style.cssText =
            ...
            resetPreview: function () {
                lt(this.previews, function (t) {
                    var e = xt(t, N);
                    gt(t, { width: e.width, height: e.height }),
                        (t.innerHTML = e.html),
                        (function (t, e) {
                            if (nt(t[e]))
                                try {
            ...
            preview: function () {
                ...
                this.cropped &&
                    !this.disabled &&
                    (gt(this.viewBoxImage, dt({ width: o, height: r }, Lt(dt({ translateX: -h, translateY: -s }, t)))),
                    lt(this.previews, function (e) {
                        var i = xt(e, N),
                            c = i.width,
                            l = i.height,
                            d = c,
                        ...
                        a && (p = n * (m = c / a)),
                            n && p > l && ((d = a * (m = l / n)), (p = l)),
                            gt(e, { width: d, height: p }),
                            gt(
                                e.getElementsByTagName("img")[0],
                                dt(
                                    { width: o * m, height: r * m },
                                    Lt(dt({ translateX: -h * m, translateY: -s * m }, t))
                                )
                            );
                    }));
            }
        ...
        Pt = {
            bind: function () {
                var t = this.element,
                    e = this.options,
                    i = this.cropper;
                ht(e.cropstart) && kt(t, A, e.cropstart),
                    ht(e.cropmove) && kt(t, S, e.cropmove),
                    ht(e.cropend) && kt(t, R, e.cropend),
                    ht(e.crop) && kt(t, X, e.crop),
                    ht(e.zoom) && kt(t, K, e.zoom),
                    kt(i, P, (this.onCropStart = this.cropStart.bind(this))),
                    e.zoomable &&
                        e.zoomOnWheel &&
                        kt(i, Q, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
                    e.toggleDragModeOnDblclick && kt(i, j, (this.onDblclick = this.dblclick.bind(this))),
                    kt(t.ownerDocument, I, (this.onCropMove = this.cropMove.bind(this))),
                    kt(t.ownerDocument, U, (this.onCropEnd = this.cropEnd.bind(this))),
                    e.responsive && kt(window, $, (this.onResize = this.resize.bind(this)));
            },
            unbind: function () {
                var t = this.element,
                    e = this.options,
                    i = this.cropper;
                ht(e.cropstart) && Bt(t, A, e.cropstart),
                    ht(e.cropmove) && Bt(t, S, e.cropmove),
                    ht(e.cropend) && Bt(t, R, e.cropend),
                    ht(e.crop) && Bt(t, X, e.crop),
                    ht(e.zoom) && Bt(t, K, e.zoom),
                    Bt(i, P, this.onCropStart),
                    e.zoomable && e.zoomOnWheel && Bt(i, Q, this.onWheel, { passive: !1, capture: !0 }),
                    e.toggleDragModeOnDblclick && Bt(i, j, this.onDblclick),
                    Bt(t.ownerDocument, I, this.onCropMove),
                    Bt(t.ownerDocument, U, this.onCropEnd),
                    e.responsive && Bt(window, $, this.onResize);
            }
        },
        It = {
            resize: function () {
            ...
            dblclick: function () {
                ...
                this.disabled ||
                    ...
                    this.setDragMode(
                        ((t = this.dragBox),
                        (e = D),
                        (t.classList ? t.classList.contains(e) : t.className.indexOf(e) > -1) ? z : L)
                    );
            },
            wheel: function (t) {
                var e = this,
            ...
            cropStart: function (t) {
                ...
                if (
                    ...
                    var a,
                        ...
                        o = this.pointers;
                    t.changedTouches
                        ? lt(t.changedTouches, function (t) {
                              o[t.identifier] = zt(t);
                          })
                        : (o[t.pointerId || 0] = zt(t)),
                        (a = Object.keys(o).length > 1 && n.zoomable && n.zoomOnTouch ? g : xt(t.target, H)),
                        G.test(a) &&
                            !1 !== Ot(this.element, A, { originalEvent: t, action: a }) &&
                            (t.preventDefault(),
                            (this.action = a),
                            (this.cropping = !1),
                            a === m && ((this.cropping = !0), ft(this.dragBox, E)));
                }
            },
            cropMove: function (t) {
                var e = this.action;
                if (!this.disabled && e) {
                    var i = this.pointers;
                    t.preventDefault(),
                        !1 !== Ot(this.element, S, { originalEvent: t, action: e }) &&
                            (t.changedTouches
                                ? lt(t.changedTouches, function (t) {
                                      dt(i[t.identifier] || {}, zt(t, !0));
                                  })
                                : dt(i[t.pointerId || 0] || {}, zt(t, !0)),
                            this.change(t));
                }
            },
            cropEnd: function (t) {
                if (!this.disabled) {
                    ...
                    t.changedTouches
                        ...
                        e &&
                            ...
                            this.cropping &&
                                ((this.cropping = !1), wt(this.dragBox, E, this.cropped && this.options.modal)),
                            Ot(this.element, R, { originalEvent: t, action: e }));
                }
            }
        },
        Ut = {
            change: function (t) {
                ...
                switch (s) {
                    ...
                    case f:
                        ...
                        X(f), (D += Y.x) < 0 && ((s = v), (l -= D = -D)), c && ((B = D / c), (d += (r.height - B) / 2));
                        break;
                    case b:
                    ...
                    case w:
                        ...
                        X(w), (B += Y.y) < 0 && ((s = b), (d -= B = -B)), c && ((D = B * c), (l += (r.width - D) / 2));
                        break;
                    case y:
                        if (c) {
                            if (Y.y <= 0 && (d <= W || O >= H)) {
                            ...
                            X(b), (B -= Y.y), (d += Y.y), (D = B * c);
                        } else
                            X(b),
                                X(f),
                                Y.x >= 0 ? (O < H ? (D += Y.x) : Y.y <= 0 && d <= W && (L = !1)) : (D += Y.x),
                    ...
                    case x:
                        if (c) {
                            ...
                            X(b), (B -= Y.y), (d += Y.y), (D = B * c), (l += r.width - D);
                        } else
                            X(b),
                                X(v),
                                Y.x <= 0
                    ...
                    case M:
                        if (c) {
                            ...
                            X(w),
                                X(f),
                                Y.x >= 0 ? (O < H ? (D += Y.x) : Y.y >= 0 && T >= N && (L = !1)) : (D += Y.x),
                                Y.y >= 0 ? T < N && (B += Y.y) : (B += Y.y);
                        D < 0 && B < 0
                            ? ((s = x), (d -= B = -B), (l -= D = -D))
                            : D < 0
                    ...
                    case m:
                        ...
                        (i = Tt(this.cropper)),
                            ...
                            (D = r.minWidth),
                            (B = r.minHeight),
                            Y.x > 0 ? (s = Y.y > 0 ? M : y) : Y.x < 0 && ((l -= D), (s = Y.y > 0 ? C : x)),
                            Y.y < 0 && (d -= B),
                            this.cropped ||
                                (vt(this.cropBox, k), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0));
                }
                L &&
                    ((r.width = D), (r.height = B), (r.left = l), (r.top = d), (this.action = s), this.renderCropBox()),
                    lt(h, function (t) {
        ...
        qt = {
            crop: function () {
                return (
                    !this.ready ||
                        ...
                        ((this.cropped = !0),
                        this.limitCropBox(!0, !0),
                        this.options.modal && ft(this.dragBox, E),
                        vt(this.cropBox, k),
            ...
            reset: function () {
                return (
                    this.ready &&
                        !this.disabled &&
                        ((this.imageData = dt({}, this.initialImageData)),
                        (this.canvasData = dt({}, this.initialCanvasData)),
                        (this.cropBoxData = dt({}, this.initialCropBoxData)),
                        this.renderCanvas(),
                        this.cropped && this.renderCropBox()),
                    this
                );
            ...
            clear: function () {
                return (
                    this.cropped &&
                        !this.disabled &&
                        (dt(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
                        (this.cropped = !1),
                        this.renderCropBox(),
                        this.limitCanvas(!0, !0),
                        this.renderCanvas(),
            ...
            enable: function () {
                return this.ready && this.disabled && ((this.disabled = !1), vt(this.cropper, B)), this;
            },
            disable: function () {
                return this.ready && !this.disabled && ((this.disabled = !0), ft(this.cropper, B)), this;
            },
            destroy: function () {
                var t = this.element;
                return t[d]
            ...
            zoomTo: function (t, e, i) {
                ...
                if ((t = Number(t)) >= 0 && this.ready && !this.disabled && a.zoomable) {
                    var c = h * t,
                        l = s * t;
                    if (!1 === Ot(this.element, K, { ratio: t, oldRatio: o / h, originalEvent: i })) return this;
                    if (i) {
                        var d = this.pointers,
                            p = Tt(this.cropper),
                            m =
            ...
            setData: function (t) {
                ...
                if (this.ready && !this.disabled && rt(t)) {
                    var o = !1;
                    e.rotatable && et(t.rotate) && t.rotate !== i.rotate && ((i.rotate = t.rotate), (o = !0)),
                        e.scalable &&
                            (et(t.scaleX) && t.scaleX !== i.scaleX && ((i.scaleX = t.scaleX), (o = !0)),
                            et(t.scaleY) && t.scaleY !== i.scaleY && ((i.scaleY = t.scaleY), (o = !0))),
                        o && this.renderCanvas(!0, !0);
                    var r = i.width / i.naturalWidth;
                    et(t.x) && (n.left = t.x * r + a.left),
                        et(t.y) && (n.top = t.y * r + a.top),
                        et(t.width) && (n.width = t.width * r),
                        et(t.height) && (n.height = t.height * r),
            ...
            getCanvasData: function () {
                ...
                return (
                    this.ready &&
                        lt(["left", "top", "width", "height", "naturalWidth", "naturalHeight"], function (i) {
                            e[i] = t[i];
                        }),
                    e
                );
            ...
            setCanvasData: function (t) {
                ...
                return (
                    this.ready &&
                        !this.disabled &&
                        rt(t) &&
                        (et(t.left) && (e.left = t.left),
                        et(t.top) && (e.top = t.top),
                        et(t.width)
                            ? ((e.width = t.width), (e.height = t.width / i))
                            : et(t.height) && ((e.height = t.height), (e.width = t.height * i)),
                        this.renderCanvas(!0)),
                    this
                );
            },
            ...
            setCropBoxData: function (t) {
                ...
                return (
                    this.ready &&
                        ...
                        !this.disabled &&
                        rt(t) &&
                        (et(t.left) && (a.left = t.left),
                        et(t.top) && (a.top = t.top),
                        et(t.width) && t.width !== a.width && ((e = !0), (a.width = t.width)),
                        et(t.height) && t.height !== a.height && ((i = !0), (a.height = t.height)),
            ...
            getCroppedCanvas: function () {
                ...
                var e = this.canvasData,
                    i = (function (t, e, i, a) {
                        var n = e.aspectRatio,
                            ...
                            N = H.getContext("2d"),
                            L = Yt({ aspectRatio: u, width: D, height: k }),
                            z = Yt({ aspectRatio: u, width: T, height: W }, "cover"),
                            Y = Math.min(L.width, Math.max(z.width, g)),
                            X = Math.min(L.height, Math.max(z.height, f)),
                            R = Yt({ aspectRatio: n, width: D, height: k }),
                            S = Yt({ aspectRatio: n, width: T, height: W }, "cover"),
                ...
                1 !== c && ((n *= c), (r *= c), (h *= c), (s *= c));
                var l = h / s,
                    d = Yt({ aspectRatio: l, width: t.maxWidth || 1 / 0, height: t.maxHeight || 1 / 0 }),
                    p = Yt({ aspectRatio: l, width: t.minWidth || 0, height: t.minHeight || 0 }, "cover"),
                    m = Yt({
                        aspectRatio: l,
            ...
            setDragMode: function (t) {
                ...
                if (this.ready && !this.disabled) {
                    ...
                    (t = n || o ? t : Y),
                        ...
                        wt(i, D, n),
                        wt(i, W, o),
                        e.cropBoxMovable || (Mt(a, H, t), wt(a, D, n), wt(a, W, o));
                }
                return this;
            }
        },
                                    ...
                                    if (V.test(t))
                                        F.test(t)
                                            ? this.read(
                                                  ...
                                                  lt((h = new Uint8Array(r)), function (t, e) {
                                                      h[e] = o.charCodeAt(e);
                                                  }),
                                                  r)
                                              )
                                        ...
                                        (this.reloading = !0),
                                            ...
                                            (s.onprogress = function () {
                                                s.getResponseHeader("content-type") !== Z && s.abort();
                                            }),
                                            (s.onload = function () {
                                                e.read(s.response);
                                            }),
                                            ...
                                            a.checkCrossOrigin && Ht(t) && i.crossOrigin && (t = Nt(t)),
                                            s.open("GET", t, !0),
                            ...
                            if (a > 1) {
                                this.url = (function (t, e) {
                                    for (var i = [], a = new Uint8Array(t); a.length > 0; )
                                        i.push(Xt.apply(null, ct(a.subarray(0, 8192)))), (a = a.subarray(8192));
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = this.element,
                                ...
                                i = t.crossOrigin,
                                a = e;
                            this.options.checkCrossOrigin && Ht(e) && (i || (i = "anonymous"), (a = Nt(e))),
                                (this.crossOrigin = i),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var i = s.navigator && /(?:iPad|iPhone|iPod).*?AppleWebKit/i.test(s.navigator.userAgent),
                                a = function (e, i) {
                                    dt(t.imageData, { naturalWidth: e, naturalHeight: i, aspectRatio: e / i }),
                                        (t.initialImageData = dt({}, t.imageData)),
                                        (t.sizing = !1),
                                        (t.sized = !0),
                                        t.build();
                                };
                        ...
                        value: function () {
                            if (this.sized && !this.ready) {
                                ...
                                (this.container = a),
                                    ...
                                    ft(s, k),
                                    e.guides || ft(s.getElementsByClassName("".concat(d, "-dashed")), k),
                                    e.center || ft(s.getElementsByClassName("".concat(d, "-center")), k),
                                    e.background && ft(o, "".concat(d, "-bg")),
                                    e.highlight || ft(c, T),
                                    e.cropBoxMovable && (ft(c, W), Mt(c, H, p)),
                                    e.cropBoxResizable ||
                                        (ft(s.getElementsByClassName("".concat(d, "-line")), k),
                                        ft(s.getElementsByClassName("".concat(d, "-point")), k)),
                                    this.render(),
                                    (this.ready = !0),
                                    this.setDragMode(e.dragMode),
                                    e.autoCrop && this.crop(),
                                    this.setData(e.data),
                                    ht(e.ready) && kt(t, q, e.ready, { once: !0 }),
                                    Ot(t, q);
                            }
                        }
                    },
                    {
                        ...
                        value: function () {
                            if (this.ready) {
                                ...
                                t && t.removeChild(this.cropper), vt(this.element, k);
                            }
                        }
                    },
                    {
    ...
    return dt(Qt.prototype, At, jt, Pt, It, Ut, qt), Qt;
});
