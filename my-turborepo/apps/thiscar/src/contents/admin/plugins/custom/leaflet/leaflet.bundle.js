...
!(function (t, e) {
    ...
    var Y = document.documentElement.style,
        ...
        Tt = !(!document.createElementNS || !J("svg").createSVGRect),
        St =
            !!Tt &&
    ...
    var jt,
        ...
        Ht,
        Vt,
        Jt = ue(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]),
        Kt = ue(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]),
    ...
    var Ye;
    et = { __proto__: null, clipPolygon: Ve, polygonCenter: Je, centroid: Ke };
    function Qe(t, e) {
        if (e && t.length) {
    ...
    var gi = fi.extend({
            ...
            getCenter: function () {
                if (this._map) return Je(this._defaultShape(), this._map.options.crs);
                throw new Error("Must add layer to map before using getCenter()");
            },
            _convertLatLngs: function (t) {
    ...
    function wi(t, e, i) {
        for (var n, o = [], s = 0, r = t.length; s < r; s++) (n = e ? wi(t[s], e - 1, i) : (i || bi)(t[s])), o.push(n);
        return o;
    }
    function Li(t, e) {
    ...
    (function (t, e) {
        ...
        function Z(t) {
            ...
            return (t.url = E(t.url.split("?")[0])), t;
        }
        function B(t) {
            ...
            return t instanceof e.LatLngBounds
                ...
                : (t.getLatLng && (t = t.getLatLng()),
                  ...
                  t instanceof e.GeoJSON &&
                      ((t = t.getLayers()[0].feature.geometry), (i.geometry = S(t)), (i.geometryType = R(t.type))),
        ...
        var q = {
                ...
                initialize: function (t) {
                    if (
                        (t.request && t.options
                            ...
                            : (e.Util.setOptions(this, t), (this.options.url = E(t.url))),
            ...
            H = W.extend({
                ...
                bboxIntersects: function (t) {
                    return (
                        this._setGeometryParams(t), (this.params.spatialRel = "esriSpatialRelEnvelopeIntersects"), this
                    );
                },
                ...
                run: function (t, e) {
                    return (
                        ...
                        this.options.isModern || (B(this.options.url) && void 0 === this.options.isModern)
                            ...
                            : this.request(function (i, n) {
                                  this._trapSQLerrors(i), t.call(e, i, n && O(n), n);
                              }, this)
                    );
                },
                count: function (t, e) {
        ...
        var $ = Y.extend({
            ...
            _responseToGeoJSON: function (t) {
                ...
                if (
                    ...
                    i && i.features && ((o.catalogItems = O(i)), n && n.length === o.catalogItems.features.length))
                )
                ...
                onAdd: function (t) {
                    F(t),
                        ...
                        this.options.attributionUrl &&
                            j((this.options.proxy ? this.options.proxy + "?" : "") + this.options.attributionUrl, t),
                        t.on("moveend", G),
        ...
        (ft.prototype.query = function (t) {
            ...
            (ft.prototype.between = function (t, e) {
                ...
                return (
                    this.values[n] && this.values[n].value === e && this.values[n + 1] && n++, this.values.slice(i, n)
                );
            }),
            ...
            (ft.prototype.bulkAdd = function (t, e) {
                return (
                    (this.values = this.values.concat([].concat(t || []))), e ? this.sort() : (this.dirty = !0), this
                );
            }),
