        ...
        return (
                        ...
                        return Promise.all(
                            ...
                            switch (!0) {
                                case -1 !== t.indexOf("Invalid"):
                                    return (
                                        e.emit("core.form.invalid", { formValidation: e }), Promise.resolve("Invalid")
                                    );
                ...
                return "radio" === n || "checkbox" === n || 1 === r.length
                    ...
                    : Promise.all(
                          ...
                          switch (!0) {
                              ...
                              default:
                                  return (
                                      t.emit("core.field.valid", e), t.results.set(e, "Valid"), Promise.resolve("Valid")
                                  );
                          }
                      });
            }),
            (e.prototype.validateElement = function (e, t) {
                ...
                return this.waterfall(s)
                    ...
                    .catch(function (n) {
                        return (
                            i.emit("core.element.notvalidated", { element: t, elements: r, field: e }),
                            Promise.resolve(n)
                        );
                    });
            }),
