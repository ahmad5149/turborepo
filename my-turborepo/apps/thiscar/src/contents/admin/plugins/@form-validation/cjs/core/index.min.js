    ...
    return (
        ...
        (e.prototype.validateElement = function (e, t) {
            ...
            if (this.filter.execute("element-ignored", !1, [e, t, r]))
                return (
                    this.emit("core.element.ignored", { element: t, elements: r, field: e }), Promise.resolve("Ignored")
                );
            ...
            return this.waterfall(s)
                ...
                .catch(function (n) {
                    return (
                        i.emit("core.element.notvalidated", { element: t, elements: r, field: e }), Promise.resolve(n)
                    );
                });
        }),
