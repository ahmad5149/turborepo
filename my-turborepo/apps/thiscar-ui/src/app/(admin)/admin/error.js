...
const sendErrorEmailFunction = async (errors, currentPath, user) => {
    ...
    <div class="content">
        ...
        <p>Hi,</p>
        <p>Exception has occurred at <strong> 'THIScar', </strong>Please review, <br/> <br/></p>
  ...
  <head>
    ...
    <body>
        ...
        <div align="center" class="alignment"
                ...
                alt="THIScar"
                 ...
                 <p>hello,</p>
                 <p>Exception has occurred at <strong> 'THIScar', </strong>Please review!</p>
    
                     <p><strong>Subject:</strong> ${emailSubject}</p>
                     <p><strong>Message:</strong> ${errors[0].message || ""}</p>
                     <p><strong>Source:</strong> ${process.env.NEXT_PUBLIC_BASE_URL}${currentPath}</p>
    ...
    try {
        await sendErrorEmail({
            ...
            cc: receivers_cc || "awais.thiscar@nxvt.com",
