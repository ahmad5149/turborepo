...
import { SearchMenuSVG, SearchMenuGreySVG } from "../../contents/svgs/cars";
                                ...
                                {item?.year && (
                                    <div
                                        ...
                                        <div className="card card-main h-100 position-relative">
                                            <Link
                                                href={`${props.dealerName}/${item.vin}`}
                                                passHref>
                                                <React.Fragment key="car-details-link">
                                                    {item.offsitePhotoUrls && item.offsitePhotoUrls.length >= 10 && (
                                                        <CarouselComponent
                                                            data={item?.offsitePhotoUrls}
                                                            status={item?.status}
                                                        />
                                                    )}
                                                    ...
                                                    <div className="card-body px-0 card-desk-active">
                                                    ...
                                                    <div className="card-mob-active">
                                                        ...
                                                        <div className="card-footer bg-white">
                                                            <p className="mb-0 f-17p">{props.carTileContactInfo}</p>
                                                        </div>
                                                    </div>
                                                </React.Fragment>
                                            </Link>
